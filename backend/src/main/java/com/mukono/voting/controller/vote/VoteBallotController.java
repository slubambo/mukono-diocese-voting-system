...
/**
 * Controller for voter-facing ballot operations.
 * Requires ROLE_VOTER authentication.
 */
@RestController
...
public class VoteBallotController {
    ...
    /**
     * Get the ballot for the authenticated voter.
     * Returns positions and candidates filtered by voter eligibility.
     * 
