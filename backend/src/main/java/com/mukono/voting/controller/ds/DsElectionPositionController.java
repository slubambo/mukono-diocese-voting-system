...
/**
 * REST controller for election position management.
 * Provides endpoints to add, remove, and list positions within elections.
 */
@RestController
...
public class DsElectionPositionController {
     ...
     */
    @PostMapping
    public ResponseEntity<ElectionPositionResponse> addPosition(
            @PathVariable Long electionId,
            @Valid @RequestBody AddElectionPositionRequest request) {
        
        var electionPosition = electionPositionService.addPosition(
                electionId,
     ...
     */
    @GetMapping
    public ResponseEntity<Page<ElectionPositionResponse>> listPositions(
            @PathVariable Long electionId,
    ...
    public ResponseEntity<ElectionPositionResponse> getPosition(
            @PathVariable Long electionId,
            @PathVariable Long fellowshipPositionId) {

        var electionPosition = electionPositionService.getByElectionAndFellowshipPosition(
                electionId,
