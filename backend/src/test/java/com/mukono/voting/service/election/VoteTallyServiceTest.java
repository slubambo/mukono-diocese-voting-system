...
public class VoteTallyServiceTest extends IntegrationTestBase {
	...
	@Autowired
	private com.mukono.voting.repository.people.PersonRepository personRepository;
	@Autowired
	private com.mukono.voting.repository.org.FellowshipRepository fellowshipRepository;
	@Autowired
	private com.mukono.voting.repository.leadership.FellowshipPositionRepository fellowshipPositionRepository;
	@Autowired
	private com.mukono.voting.repository.leadership.PositionTitleRepository positionTitleRepository;

	@Test
	void countsVotesAndTurnoutCorrectly() {
		// Setup election and period
		com.mukono.voting.model.org.Fellowship fellowship = new com.mukono.voting.model.org.Fellowship(
				"Test Fellowship", "TF");
		...
		com.mukono.voting.model.leadership.PositionTitle title = new com.mukono.voting.model.leadership.PositionTitle(
				"Chairperson");
		...
		// Candidates
		Person voter1 = new Person("Voter One");
		personRepository.save(voter1);
		Person voter2 = new Person("Voter Two");
		personRepository.save(voter2);
		Person voter3 = new Person("Voter Three");
		personRepository.save(voter3);
		...
		Map<Long, Long> counts = voteTallyService.countVotesByCandidate(election.getId(), period.getId(),
				position.getId());
	...
	void electionTurnoutCountsUniqueVotersAcrossPositions() {
		...
		// Two positions
		com.mukono.voting.model.leadership.PositionTitle t1 = new com.mukono.voting.model.leadership.PositionTitle(
				"Treasurer");
		com.mukono.voting.model.leadership.PositionTitle t2 = new com.mukono.voting.model.leadership.PositionTitle(
				"Coordinator");
		...
		ElectionPosition pos1 = new ElectionPosition(election, fellowship, fp1, 1);
		...
		ElectionPosition pos2 = new ElectionPosition(election, fellowship, fp2, 1);
		pos2 = positionRepository.save(pos2);

		// Voters and candidates per position
		Person voter = new Person("Only Voter");
	...
	private void createVote(Person voter, Election election, VotingPeriod period, ElectionPosition position,
