        ...
        <MasterDataHeader
          ...
          filters={[
            ...
            },
            {
              ...
              options: [{ id: null, name: '-- All --' }, ...dioceses.map((d) => ({ id: d.id, name: d.name }))],
            ...
            },
            {
              ...
              label: 'Level',
              value: filterLevel,
              options: [{ id: null, name: '-- All --' }, ...levels.map((l) => ({ id: l, name: `${l.charAt(0)}${l.slice(1).toLowerCase()}` }))],
            ...
            },
            {
              ...
              options: [{ id: null, name: '-- All --' }, ...archdeaconries.map((a) => ({ id: a.id, name: a.name }))],
            ...
            },
            {
              ...
              options: [{ id: null, name: '-- All --' }, ...churches.map((c) => ({ id: c.id, name: c.name }))],
            ...
            },
            {
              ...
              options: [{ id: null, name: '-- All --' }, ...fellowships.map((f) => ({ id: f.id, name: f.name }))],
